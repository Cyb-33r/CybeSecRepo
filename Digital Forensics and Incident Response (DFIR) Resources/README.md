...
* [CAINE](http://www.caine-live.net/index.html) - The Computer Aided Investigative Environment (CAINE), contains numerous tools that help investigators with analyses, including forensic evidence collection.
* [Skadi](https://github.com/orlikoski/Skadi">https://github.com/orlikoski/Skadi) This all-in-one solution to parsing collected data makes the data easily searchable with built-in common searches and enables searching of single and multiple hosts simultaneously. You can download CCF-VM from <a href="https://github.com/rough007/CCF-VM" title="https://github.com/rough007/CCF-VM">https://github.com/rough007/CCF-VM</a>.
